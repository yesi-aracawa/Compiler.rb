...
{ INSTRUCTION currentinstruction  ;
  ...
  { # instrcciones RR */
    ...
    # fin de las instruicciones legales */
  } # case */
  return srOKAY ;
} # stepTM */
...
{ if (argc != 2)
  ...
  if ( ! readInstructions ())
         exit(1) ;
  #archivo de entrada comuta a terminal */
  # reset (input); */
  # lee-eval-imprime */ 
