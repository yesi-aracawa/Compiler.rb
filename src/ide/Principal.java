...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_semantica = new javax.swing.JPanel();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(jScrollPane8, javax.swing.GroupLayout.PREFERRED_SIZE, 1121, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane_VentanaErrores.addTab("Tabla de Símbolos", jPanel3);
        ...
        javax.swing.GroupLayout jPanel_semanticaLayout = new javax.swing.GroupLayout(jPanel_semantica);
        jPanel_semantica.setLayout(jPanel_semanticaLayout);
        jPanel_semanticaLayout.setHorizontalGroup(
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane5, javax.swing.GroupLayout.DEFAULT_SIZE, 1144, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(2, 2, 2)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jTabbedPane_Ventana, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jMenuItem_InstrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_InstrActionPerformed
        ...
        String texto = "Instrucciones\n"
                ...
                + "los elementos de programa que controlan cómo y en qué orden se "
                + "manipulan los objetos. Esta sección incluye Información general\n"
                + "Instrucciones de expresión. Estas instrucciones evalúan una expresión para ver sus "
                + "efectos secundarios o para averiguar su valor devuelto.\n"
                + "Instrucciones NULL. Estas instrucciones se pueden proporcionar "
                + "cuando la sintaxis de C++ requiere una instrucción pero no se va "
                + "a realizar ninguna acción.\n"
                + "Instrucciones compuestas. Estas instrucciones son grupos de instrucciones "
                + "entre llaves ({}). Se pueden utilizar donde se puede utilizar una sola instrucción.\n"
                + "Instrucciones de selección. Estas instrucciones realizan una prueba; a continuación, "
                + "ejecutan una sección de código si la prueba se evalúa como true (distinto de cero). "
                + "Pueden ejecutar otra sección de código si la prueba se evalúa como false.\n"
                + "Instrucciones de iteración. Estas instrucciones ejecutan repetidamente un bloque de código hasta que "
                + "se cumple un criterio de finalización especificado.\n"
                + "Instrucciones de salto. Estas instrucciones transfieren el control inmediatamente "
                + "a otra ubicación de la función o devuelven el control de la función.\n"
                + "Instrucciones de declaración. Las declaraciones introducen un nombre en un programa. "
                + "(En Declaraciones se proporciona información más detallada sobre las declaraciones).";
